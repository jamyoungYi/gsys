		    ...
		    <td align="left" valign="top">
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
			  		<tr>
			  		 	...
			  		 	<td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="<%=path %>/jsp/spAdd.jsp" target="main" onFocus="this.blur()" class="add">新增商品</a></td>
			  		</tr>
				</table>
		    </td>
		  </tr>
		  	...
		  	<td align="left" valign="top">
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      			<tr>
				        ...
				        <th align="center" valign="middle" class="borderright">生产厂商</th>
				        ...
				        <th align="center" valign="middle">操作</th>
							...
							<c:forEach items="${goodsList}" var="goods" varStatus="status">
								<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
									...
									<td align="center" valign="middle" class="borderright borderbottom">${goods.g_name}</td>
									<td align="center" valign="middle" class="borderright borderbottom">${goods.type}</td>
									<td align="center" valign="middle" class="borderright borderbottom">${goods.count}</td>
									<td align="center" valign="middle" class="borderright borderbottom">${goods.buyprice}</td>
									<td align="center" valign="middle" class="borderright borderbottom">${goods.price}</td>
									<td align="center" valign="middle" class="borderright borderbottom">${goods.manufacturer}</td>
									<td align="center" valign="middle" class="borderright borderbottom">${goods.lbid}</td>
									<td align="center" valign="middle" class="borderbottom">
										<a href="<%=path%>/goods/toUpdate?id=${goods.id}" target="main" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
										<a href="<%=path%>/goods/deleteGoods?id=${goods.id}" target="main" onFocus="this.blur()" class="add">删除</a><span class="gray">&nbsp;|&nbsp;</span>
										<a href="<%=path%>/goods/toSee?id=${goods.id}" target="main" onFocus="this.blur()" class="add">查看</a>
									</td>
								</tr>
							</c:forEach>
	    		</table>
