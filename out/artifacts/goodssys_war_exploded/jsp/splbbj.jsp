...
<html>
  <head>
    ...
    <title>My JSP 'updateSplb.jsp' starting page</title>
  ...
  <!--main_top-->
	  ...
	  <tr>
	  	<td width="99%" align="left" valign="top">您的位置：商品管理&nbsp;&nbsp;>&nbsp;&nbsp;类别管理&nbsp;&nbsp;>&nbsp;&nbsp;商品类别编辑</td>
	  </tr>
	  <tr>
	    <td align="left" valign="top" id="addinfo">
	    	<a href="<%=path%>/jsp/splbList.jsp" target="main" onFocus="this.blur()" class="add">返回上一级</a>
	    </td>
	  </tr>
	  <tr>
	    <td align="left" valign="top">
	    	<form method="post" action="<%=path%>/goodsType/updateGoodsType">
	    		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
				    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
				        <td align="right" valign="middle" class="borderright borderbottom bggray">类别名称：</td>
				        <td align="left" valign="middle" class="borderright borderbottom main-for">
				        	<input type="hidden" name="id" value="${QGoodsType.id }">
				        	<input type="text" name="t_name" value="${QGoodsType.t_name }" class="text-word">
				        </td>
			        </tr>
	      			<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
