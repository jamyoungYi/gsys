			  		...
			  		<tr>
			   			<td width="90%" align="left" valign="middle">
					         <form method="post" action="<%=path%>/customer/findByNameAndByContactCustomerLike">
						         ...
						         <span>联系人：</span>
						         <input type="text" name="contacts" class="text-word">
						         <input name="" type="submit" value="查询" class="text-but">
					         </form>
			         	</td>
			  		 	<td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="<%=path %>/jsp/khAdd.jsp" target="main" onFocus="this.blur()" class="add">新增客户</a></td>
			  		</tr>
				</table>
		    </td>
		  </tr>
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
					...
					<c:forEach items="${customersList}" var="customers" varStatus="status">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
							...
							<td align="center" valign="middle" class="borderright borderbottom">${customers.c_name}</td>
							<td align="center" valign="middle" class="borderright borderbottom">${customers.contacts}</td>
							<td align="center" valign="middle" class="borderright borderbottom">${customers.phone}</td>
							<td align="center" valign="middle" class="borderright borderbottom">${customers.address}</td>
							<td align="center" valign="middle" class="borderright borderbottom">${customers.remarks}</td>
							<td align="center" valign="middle" class="borderbottom">
								<a href="<%=path%>/customer/toUpdateCustomer?id=${customers.c_id}" target="main" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
								<a href="<%=path%>/customer/deleteCustomer?id=${customers.c_id}" target="main" onFocus="this.blur()" class="add">删除</a>
							</td>
						</tr>
					</c:forEach>
	    		</table>
